...
namespace SlidingTiles {
    ...
    public:
        ...
        /**
             * @brief calculate the screen coordinates for a tile from the x and y position
             */
        sf::Vector2i calculateCoordinates(const sf::Vector2i& coord) const;

        /**
             * @brief figure out the tile coordinates for a given screen position
             * if position is outside the grid return -1, -1
             */
        sf::Vector2i findTile(sf::Vector2i mousePosition) const;
