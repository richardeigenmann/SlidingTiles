...
TEST(RenderingSingleton, ObjectCreation) { RenderingSingleton::getInstance(); }
...
TEST(RenderingSingleton, FindTile02) {
  sf::Vector2i tile =
      RenderingSingleton::getInstance().findTile(sf::Vector2i{142, 251});
  ASSERT_EQ(tile.x, 0);
  ASSERT_EQ(tile.y, 2);
}
...
TEST(RenderingSingleton, FindTileOutSideGrid1) {
  sf::Vector2i tile =
      RenderingSingleton::getInstance().findTile(sf::Vector2i{50, 50});
  ASSERT_EQ(tile.x, -1);
  ASSERT_EQ(tile.y, -1);
}
...
TEST(RenderingSingleton, FindTileOutSideGrid2) {
  sf::Vector2i tile =
      RenderingSingleton::getInstance().findTile(sf::Vector2i{50, 150});
  ASSERT_EQ(tile.x, -1);
  ASSERT_EQ(tile.y, -1);
}

TEST(RenderingSingleton, FindTileOutSideGrid3) {
  sf::Vector2i tile = RenderingSingleton::getInstance().findTile(
      sf::Vector2i{50, 110 + 4 * RenderingSingleton::tileSize});
  ASSERT_EQ(tile.x, -1);
  ASSERT_EQ(tile.y, -1);
}
...
TEST(RenderingSingleton, FindTileOutSideGrid5) {
  sf::Vector2i tile =
      RenderingSingleton::getInstance().findTile(sf::Vector2i{150, 50});
  ASSERT_EQ(tile.x, -1);
  ASSERT_EQ(tile.y, -1);
}
...
TEST(RenderingSingleton, FindTileOutSideGrid6) {
  sf::Vector2i tile = RenderingSingleton::getInstance().findTile(
      sf::Vector2i{110 + 4 * RenderingSingleton::tileSize, 150});
  ASSERT_EQ(tile.x, -1);
  ASSERT_EQ(tile.y, -1);
}
